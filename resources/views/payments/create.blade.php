    ...
    <div class="bg-blue-50 rounded-xl shadow-lg p-10">
        ...
        <form method="POST" action="{{ route('payments.store') }}" class="space-y-6">
            ...
            <div>
                ...
                <select name="eleve_id" required class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white text-blue-900">
            ...
            <div>
                <label class="block mb-2 text-blue-700 font-semibold">Type de frais</label>
                <select name="fee_type_id" required class="w-full border border-blue-200 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-300 bg-white text-blue-900">
